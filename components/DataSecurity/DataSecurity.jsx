  ...
  return (
    <div className="data-security-container">
      <div className="data-security-box">
        <h1 className="data-security-title">Segurança dos dados</h1>
            ...
            <li className="security-rule-list-item">
              ...
              <div className="security-rule-list-item-text">
                ...
                <h1 className="security-rule-subText">
                  <a href="#">Saiba mais</a> sobre como os desenvolvedores
                  declaram o compartilhamento
                </h1>
              </div>
            </li>
            <li className="security-rule-list-item">
              ...
              <div className="security-rule-list-item-text">
                ...
                <h1 className="security-rule-subText">
                  <a href="#">Saiba mais</a> sobre como os desenvolvedores
                  declaram a coleta de seus dados
                </h1>
              </div>
            </li>
          </ul>
